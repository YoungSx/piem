...
5. Show the plan before changing files. Only edit tags after explicit approval. Apply frontmatter tag changes with update_frontmatter (it preserves YAML formatting) and inline hashtag changes with edit — do not hand-rewrite YAML with write. Report every changed note.
