---
name: tag-organize
description: "Audit tags and propose a consistent, low-noise tag structure. Use when the user asks to clean up, merge, or review tags, or complains about tag chaos or duplicates."
...
5. Show the plan before changing files. Only edit after explicit approval.
6. To apply the mapping, use update_frontmatter for frontmatter tags — it writes the YAML header atomically. Inline hashtags in note bodies need edit per note. Preserve frontmatter formatting; report every changed note.
