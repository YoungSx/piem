...
export const en = {
	...
	extensions: {
		...
		catalog: {
			...
			modelSwitchName: "Model switching",
			modelSwitchDesc: "Lets the agent switch to a different configured model partway through a conversation.",
			contextName: "Context management",
			contextDesc: "Gives the agent tools to checkpoint, compact and review its own context. The /context view stays available either way.",
			agentTeamName: "Agent team",
			agentTeamDesc: "Adds team tools that run independent Pi agents with their own mailbox and audit trail.",
			clarifyName: "Draft rewriting",
			clarifyDesc: "Rewrites a rough prompt into a precise one before sending, via /clarify or the -clarify marker. Sends the draft to its chosen model.",
			continueName: "Invisible continue",
...
/** The scout's chip: `{finding}` is the model's own label for what it found. */
	...
	extensionUI: {
		...
		todoBadgeAria: "{completed} of {total} done",
	...
	subagents: {
		...
		processPending: "Recording this run's steps…",
