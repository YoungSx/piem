 ...
 * 22. The Pi extension compat bridge P2 (issue #419: compaction lineage,
 ...
 *
 * 27. Per-extension enable switches on the Extensions tab — a `disabledExtensions`
 *     blocklist, the CommunityHost load-time filter that reads it, a display
 *     catalog for the eight offered ids and bilingual copy — measured
 *     2,442,962 B (+~3.7 KiB over #26). The ceiling follows to 2.34 MiB. No new
